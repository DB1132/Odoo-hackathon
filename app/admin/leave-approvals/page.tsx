      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex gap-6 py-3">
            ...
            <Link href="/admin/leave-approvals" className="text-sm font-medium text-blue-600 border-b-2 border-blue-600 pb-3">Leave Approvals</Link>
            <Link href="/admin/payroll" className="text-sm font-medium text-gray-600 hover:text-gray-900 pb-3">Payroll</Link>
          </nav>
        </div>
      </div>
