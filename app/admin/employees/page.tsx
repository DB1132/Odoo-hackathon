      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex gap-6 py-3">
            <Link href="/admin-dashboard" className="text-sm font-medium text-gray-600 hover:text-gray-900 pb-3">
              Dashboard
            </Link>
            <Link href="/admin/employees" className="text-sm font-medium text-blue-600 border-b-2 border-blue-600 pb-3">
              Employees
            </Link>
